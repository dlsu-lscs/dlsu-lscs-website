...
export default function AwardsCard({ rank, awardName, projectName, year }: AwardsCardProps) {
  return (
    <>
      <div className="bg-[#4A4949] w-[clamp(280px,30vw,405px)] shadow-[12px_12px_28px_rgba(0,0,0,0.18),-2px_-2px_12px_rgba(255,255,255,0.2)] hover:shadow-xl hover:scale-[1.03] hover:bg-[#575656] active:scale-[0.98] transition-[transform,box-shadow,background-color] will-change-transform duration-300 ease-in-out rounded-lg px-3 py-2">
