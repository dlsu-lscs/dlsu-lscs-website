...
export default function PartnerCard({ partner }: PartnerCardProps) {
  return (
    <div className="w-full sm:w-[280px] md:w-[300px] h-auto sm:h-[360px] bg-[radial-gradient(circle_at_center,_#f5f5f5_0%,_#e5e5e5_70%,_#d9d9d9_100%)] rounded-xl shadow-[12px_12px_28px_rgba(0,0,0,0.18),-6px_-6px_18px_rgba(255,255,255,0.9)] hover:shadow-xl hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-2 p-4 sm:p-6 overflow-hidden">
