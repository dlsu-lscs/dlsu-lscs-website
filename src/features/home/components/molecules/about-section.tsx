  ...
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-col gap-4 sm:gap-6 lg:gap-8 md:flex-row md:items-center md:min-h-screen">
      <section className="flex flex-col flex-1 min-w-0 text-center md:text-left">
        ...
        <Link
          href="/about-us"
          className="flex justify-center items-center bg-linear-to-b from-[#1A5D89] to-[#071823] hover:from-[#2173a9] hover:to-[#0f2838] transition-all duration-300 transform hover:scale-[1.05] active:scale-[0.97] hover:shadow-lg rounded-[10px] px-6 py-2 sm:px-8 sm:py-3 lg:px-9 lg:py-3 w-full sm:w-64 lg:w-56 text-lg sm:text-xl font-medium text-white mx-auto lg:mx-0 hover:cursor-pointer shadow-md text-center"
        >
          {buttonText}
        </Link>
      </section>
