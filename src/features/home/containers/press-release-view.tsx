...
export default function PressReleaseView() {
  return (
    <>
      <main className="min-h-screen w-full bg-white border-t-black border-2 overflow-x-hidden">
          ...
          <Carousel>
            <CarouselContent>
              {pressReleasesData.pressReleases.map((pressRelease: PressReleaseType, index) => (
                <CarouselItem key={index} className="sm:basis-1/4 md:basis-1/2 lg:basis-1/4">
                  <PressReleaseCard
